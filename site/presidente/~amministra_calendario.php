...
<h2><?echo "Giornata " .$id;?></h2>

<p>Data Inizio: <input type="text" id="datepicker.<? echo $id ?>" value="<?echo $inizio ;?>">
 
Ora inizio: <input type="text" id="timepicker.<? echo $id ?>"></p>

<h3><?echo $inizio ."  -->  " .$fine ;?></h3>
...
<td><font face="Arial, Helvetica, sans-serif"><? echo "$sq_casa"; ?></font></td>
<td><font face="Arial, Helvetica, sans-serif"><? echo "$sq_ospite"; ?></font></td>

<td><font face="Arial, Helvetica, sans-serif"><? echo "$gol_casa"; ?></font></td>
<td><font face="Arial, Helvetica, sans-serif"><? echo "$gol_ospite"; ?></font></td>
<td><font face="Arial, Helvetica, sans-serif"><? echo "$punti_casa"; ?></font></td>
<td><font face="Arial, Helvetica, sans-serif"><? echo "$punti_ospite"; ?></font></td>
</tr>
