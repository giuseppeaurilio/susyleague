...
<script>
    SalvaGirone = function(){
        ...
        $.ajax({
                type:'POST',
                url:'torneoconsolazione_c_salvagiorone.php',
    ...
    GeneraCalendario = function(){
        ...
        $.ajax({
                type:'POST',
                url:'torneoconsolazione_c_generacalendario.php',
                data: {"idsquadre": JSON.stringify(idsquadre)},
                success:function(data){
                    //debugger;
                    var resp=$.parseJSON(data)
    ...
    CaricaGirone = function(){
        $.ajax({
                type:'POST',
                url:'torneoconsolazione_c_getgirone.php',
                data: {"girone": "unico"},
                dataType:"json", 
                success:function(data){
                    // debugger;
...
?>
<div>
    <a href="torneoconsolazione_calendario.php" >Calendario Incontri</a>
</div>
<?php 
include("footer.html");
?>
