...
window.onclick = function(e) {
  if (!e.target.matches('.dropbtn')) {
    ...
    for (var d = 0; d < dropdowns.length; d++) {
	 ...
	 <div id="wrap">
		  <ul class="navbar">
			 <li><a href="/site/homepage/home.php">Home</a></li>
			 <li><a href="/site/display_classifiche.php">Classifiche</a></li>
			 <li><a href="#">Calendari</a>
				<ul>
				   <li><a href="/site/display_calendario.php?&id_girone=1">Calendario Apertura</a></li>
				   <li><a href="/site/display_calendario.php?&id_girone=2">Calendario Chiusura</a></li>
				   <li><a href="/site/display_calendario.php?&id_girone=3">Calendario Finale</a></li>
				</ul>         
			 </li>
			 <li><a href="#">Rose</a>
				<ul>
				   <li><a href="/site/display_rose.php" >Susy League</a></li>
				   <li><a href="/site/display_giocatori.php">Serie A</a></li>
				   <li><a href="/site/display_asta.php">Asta</a></li>
				</ul>         
			 </li>
			 <li><a href="/site/invio_formazione.php">Invio formazione</a></li>
			 <li><a href="#">Social</a>
				<ul>
				   <li><a href="/site/display_sondaggi.php">Sondaggi</a></li>
				   <li><a href="/site/display_mercato.php">Mercato</a></li>

				</ul>         
			 </li>
			 <li><a href="/site/cambia_password.php" >Password</a></li>
			 <li><a href="/site/homepage/regolamento.pdf" >Regolamento</a></li>
			 <li><a href="/site/presidente/amministrazione.php" >Amministrazione</a></li>
		  </ul>
		 </div>
