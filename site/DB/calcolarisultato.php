...
class Votazione
{
    ...
    public $votomd;
    public $sostituzione;
    public function Votazione($_idgiocatore, $_ruolo, $_idposizione, $_voto, $_votomd, $_sostituzione)
    {
        ...
        $this->voto = $_voto;
        $this->votomd = $_votomd;
        $this->sostituzione = $_sostituzione;
    }
}
...
// echo $query;
        ...
        if($sostituzionidafare > $sostituzionifatte && $attdasostituire > 0 )// se devo sostituire attaccanti
        {
            for($index = 1; $index<= $attdasostituire; $index++)//ciclo per i attaccanti da sostituire 
            {
                if(count($risattcv)> 0)
                {
        ...
        /// è il presidente ad inserire il voto dei soli panchinari che entrano
        ///-------------------------------------------------------------------------------------------
    ...
    private function calcolaMediaDifesa($_numdif, $_sommavoti, $calcola)
    {
        ...
        if ($_numdif == 5)
        {
            ...
            elseif ($_sommavoti >= 20. && $_sommavoti < 21.25) {$ret = 6;} 
            elseif ($_sommavoti >= 21.25 && $_sommavoti < 22.5) {$ret = 5;} 
            elseif ($_sommavoti >= 22.5 && $_sommavoti < 23.75) {$ret = 4;} 
            elseif ($_sommavoti >= 23.75 && $_sommavoti < 25) {$ret = 3;} 
            elseif ($_sommavoti >= 25 && $_sommavoti < 26.25) {$ret = 2;} 
            elseif ($_sommavoti >= 26.25 && $_sommavoti < 27.5) {$ret = 1;} 
            elseif ($_sommavoti >= 27.5 && $_sommavoti < 28.75) {$ret = 0;} 
            elseif ($_sommavoti >= 28.75 && $_sommavoti < 30) {$ret = -1;} 
            elseif ($_sommavoti >= 30 && $_sommavoti < 31.25) {$ret = -2;} 
            elseif ($_sommavoti >= 31.25 && $_sommavoti < 32.5) {$ret = -3;} 
            elseif ($_sommavoti >= 32.5 && $_sommavoti < 33.75) {$ret = -4;} 
            elseif ($_sommavoti >= 33.75 && $_sommavoti < 35) {$ret = -5;} 
            elseif ($_sommavoti >= 35 && $_sommavoti < 36.25) {$ret = -6;} 
            elseif ($_sommavoti >= 36.25 && $_sommavoti < 37.5) {$ret = -7;} 
            elseif ($_sommavoti >= 37.5) {$ret = -8;} 
        }
