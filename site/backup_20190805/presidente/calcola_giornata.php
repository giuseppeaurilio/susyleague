...
>
	...
	<?php if ($i==11) {echo "<th bgcolor='#FFFFFF' rowspan='8'>Riserve</th>";  } ?>
            	...
            	<td><?php echo mysql_result($result_formazione,$i,"squadra_breve"); ?></td>
	...
	$numero_giocanti=mysql_result($risultati,0,"numero_giocanti_casa");	
	}
	...
	if ($num_risultati>0) {	$voto_netto_ospite=mysql_result($risultati,0,"voto_ospite");
	...
	$numero_giocanti_ospite=mysql_result($risultati,0,"numero_giocanti_ospite");
	}
