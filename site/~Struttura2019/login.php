...
if (!(isset($allenatore) && $allenatore != '')) {
    ...
    echo '<div id="pnlLogin" style="display: none;">';
        echo '<div >';
            ...
            {
                echo "<option value='".$squa['id']."'>".$squa['squadra']."</option>"; 
            }
            echo "</select>";
        echo '</div >';
        echo '<div >';
    ...
    echo 'Benvenuto ' . $allenatore . '<i class="fas fa-sort-down"></i>';
    // <a href="/cambia_password.php" ><i class="fas fa-unlock-alt"></i> Password</a>
    // <a href="/cambia_password.php" ><i class="fas fa-unlock-alt"></i> Logout</a>
}
?>
</div>
<script>
    $(document).ready(function(){
        ...
        $("#btnLogin").off("click").bind("click", doLogin);
    });
