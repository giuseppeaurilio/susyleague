...
//     order by fine desc
    ...
    for ($girone = 1; $girone <= 10; $girone++) {
        ...
        if(count($risultati) >0){
            echo '<div style="background-color: rgba(255,255,255,0.8)">';
            ...
            switch ($girone)
            {
                ...
                case 2:
                case 6:
                    echo '<div><a href="/display_calendario.php?id_girone='.$girone.'">Consulta il calendario.</a></div>';    
                break;
                case 4:
                    echo '<div><a href="/display_calendario_coppaitalia_gironi.php">Consulta il calendario.</a></div>';    
                break;
                case 5:
                    echo '<div><a href="/display_calendario_coppaitalia_tabellone.php">Consulta il calendario.</a></div>';    
                break;
                case 7:
                case 8:
                    echo '<div><a href="/display_calendario_finali.php">Consulta il calendario.</a></div>';    
                break;
            }
    ...
    if($counter ==0)
    {
        ...
        echo '<div><a href="/display_calendario.php?id_girone=1">Consulta il calendario.</a></div>';    
    }
