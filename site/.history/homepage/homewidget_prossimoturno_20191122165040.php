    ...
    for ($girone = 1; $girone <= 10; $girone++) {
        ...
        if(count($partite) >0){
            ...
            foreach($partite as $partita){
                ...
                <div style="width:40%; display:inline-block;" class="'. $partita["luc"] = '0' ? "missing" :"sent".'">'.$partita["luc"]. $partita["sq_casa"].'</div>
                <div style="width:10%; display:inline-block;">-</div>
                <div style="width:40%; display:inline-block;" class="'. $partita["luo"] ='0' ? "missing" :"sent".'">'.$partita["luo"]. $partita["sq_ospite"].'</div>
                </div>';
