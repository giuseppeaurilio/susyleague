    ...
    for ($girone = 1; $girone <= 10; $girone++) {
        ...
        if(count($partite) >0){
            ...
            foreach($partite as $partita){
                ...
                echo '<div class="result alternate" style="text-align:center">';
                echo '<div><spanstyle="float:left;">'. $partita["sq_casa"].'</span><span>-</span><span style="float:right;">'. $partita["sq_ospite"].'</span></div>';
