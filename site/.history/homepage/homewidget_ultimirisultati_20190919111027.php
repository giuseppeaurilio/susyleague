    ...
    for ($girone = 1; $girone <= 10; $girone++) {
        ...
        if(count($risultati) >0){
            ...
            foreach($risultati as $risultato){
                ...
                // echo '<br>';
                echo '<div>';
                echo '<div>'. $risultato["sq_casa"].' ('.$risultato["voto_casa"].')<span>'.$risultato["gol_casa"].'</span></div>';
                echo '<div>'. $risultato["sq_ospite"].' ('.$risultato["voto_ospite"].')<span>'.$risultato["gol_ospite"].'</span></div>';
                echo '</div>';
                }
            echo '</div>';
