...
">
	...
	?>
	<?php if ($i==0) {echo 	"<td rowspan='11' style='background-color: white;'><div class=''> Titolari</div></td>";  } ?>
	<?php if ($i==11) {echo "<td rowspan='8' style='background-color: white;'><div class=''> Riserve </div></td>";  } ?>
...
?>
	...
	<?php if ($i==11) {echo "<td rowspan='8' style='background-color: white;'><div class='rotate'> Riserve </div></td>";  } ?>
		<td><?php echo '<img style="width:20px;height:27px;" src='.$filename.'>';?></td>
