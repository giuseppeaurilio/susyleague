		...
		while ($row=$result_giornata->fetch_assoc()) {
			...
			<tr>
				...
				if ($id_squadra != "" && $id_squadra==$id_casa) {
					...
					echo '<td style="background: lightgoldenrodyellow;"><a href="'. $link . '?&id_giornata=' .$id . '&id_squadra=' . $id_casa . '">'. $sq_casa .'</a></td>';
				}
				else {
					// echo '<li>' .$sq_casa .'</li>';
					echo '<td>' .$sq_casa .'</td>';
				...
				if ($id_squadra != "" && $id_squadra==$id_ospite) {
					...
					echo '<td style="background: lightgoldenrodyellow;"><a href="'. $link . '?&id_giornata=' .$id . '&id_squadra=' . $id_ospite . '">'. $sq_ospite .'</a></td>';
				}
				else {
