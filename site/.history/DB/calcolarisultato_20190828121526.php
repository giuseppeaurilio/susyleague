...
class Partita
{
    ...
    private function calcolaMediaDifesa($_numdif, $_sommavoti)
    {
        ...
        {
            if ($_sommavoti >= 18 && $_sommavoti < 18.75) {$ret = 0;} 
            elseif ($_sommavoti >= 17.25 && $_sommavoti < 18) {$ret = 1;} 
            elseif ($_sommavoti >= 16.50 && $_sommavoti < 17.25) {$ret = 2;} 
            elseif ($_sommavoti >= 15.75 && $_sommavoti < 16.50) {$ret = 3;} 
            ...
            elseif ($_sommavoti <15 ) {$ret = 10;} 
            elseif ($_sommavoti >21.75) {$ret = -10;} 
        }
        if ($_numdif == 4)
        {
            if ($_sommavoti >= 23 && $_sommavoti < 24) {$ret = 0;} 
            elseif ($_sommavoti >= 22 && $_sommavoti < 23) {$ret = 1;} 
            elseif ($_sommavoti >= 23 && $_sommavoti < 24) {$ret = 2;} 
            elseif ($_sommavoti >= 24 && $_sommavoti < 25) {$ret = 3;} 
            elseif ($_sommavoti >= 25 && $_sommavoti < 26) {$ret = 4;} 
            elseif ($_sommavoti >= 18.75 && $_sommavoti < 19.5) {$ret = -1;} 
            elseif ($_sommavoti >= 19.5 && $_sommavoti < 20.25 ) {$ret = -2;} 
            elseif ($_sommavoti >= 20.25 && $_sommavoti < 21 ) {$ret = -3;} 
            elseif ($_sommavoti >= 21 && $_sommavoti < 21.75 ) {$ret = -4;} 
