...
class Partita
{
    ...
    public function Partita($_idgiornata, $_idcasa, $_idospite, $usamediadifesa, $usafattorecasa)
    {
        $this->idgiornata = $_idgiornata;
        $this->idcasa = $idcasa;
        $this->idospite = $idospite;
        $this->usamediadifesa = $usamediadifesa;
        $this->usafattorecasa = $usafattorecasa;

    }
    public function calcolaRisultatoPartita()
    {
        $risultatocasa = calcolaRisultatoSquadra($this->idgiornata, $this->idcasa);
