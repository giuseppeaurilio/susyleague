...
class Partita
{
    ...
    {
        $punteggiocasa = $this->calcolaRisultatoSquadra($this->idgiornata, $this->idpartita, $this->idcasa);
        $punteggioospite = $this->calcolaRisultatoSquadra($this->idgiornata, $this->idpartita, $this->idospite);
