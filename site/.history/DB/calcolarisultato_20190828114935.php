...
class Partita
{
    ...
    public function calcolaRisultatoPartita()
    {
        ...
        $risultatoospite = $this->calcolaRisultatoSquadra($this->idgiornata, $this->idospite);
    }
    ...
    private function calcolaRisultatoSquadra($idgiornata, $idsquadra)
    {
        ...
        if($boolprint) echo  'Squadra'. $idsquadra .'voti'.print("<pre>".print_r($arrayvoti,true)."</pre>").'<br>';
        // print_r($arrayvoti);
