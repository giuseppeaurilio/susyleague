...
class RisultatoSquadra
{
    ...
    public $mediadifesa;
    public function Risultato($punteggio, $giocatoriconvoto, $mediadifesa)
    {
...
class Partita
{
    ...
    public function Partita($_idgiornata, $_idpartita, $_idcasa, $_idospite, $_usamediadifesa, $_valorefattorecasa)
    {
    ...
    {
        $punteggiocasa = $this->calcolaRisultatoSquadra($this->idpartita, $this->idcasa);
        $punteggioospite = $this->calcolaRisultatoSquadra($this->idpartita, $this->idospite);
        include "../globalsettings.php"; 
        if($boolprint) echo  print("<pre>".print_r($punteggiocasa,true)."</pre>").'<br>';
        if($boolprint) echo  print("<pre>".print_r($punteggioospite,true)."</pre>").'<br>';
        ...
        return new RisultatoPartita($punteggiocasa->punteggio,$this->usamediadifesa ?  $punteggiocasa->mediadifesa: 0 ,$this->valorefattorecasa, $golcasa )
    }
    
    private function calcolaRisultatoSquadra($idgiornata, $idpartita, $idsquadra)
    {
        include "../globalsettings.php"; 
