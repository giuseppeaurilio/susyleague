    ...
    private function calcolaRisultatoSquadra($idgiornata, $idsquadra)
    {
        ...
        if($sostituzionidafare > $sostituzionifatte && $numporcv != 1)// se manca il portiere
        {
            if(count($risporcv)> 0)
            {
                ...
                if($boolprint) echo 'sostituito portiere';
        ...
        if($sostituzionidafare > $sostituzionifatte && $difdasostituire > 0 )// se devo sostituire difensori
        {
            for($index = 1; $index<= $difdasostituire; $index++)//ciclo per i difensori da sostituire 
            {
                if(count($risdifcv)> 0)
                {
                    ...
                    if($boolprint) echo 'sostituito difensore';
                }
            }
        }
        ...
        if($sostituzionidafare > $sostituzionifatte && $cendasostituire > 0 )// se devo sostituire centrocampisti
        {
            for($index = 1; $index<= $cendasostituire; $index++)//ciclo per i centrocampisti da sostituire 
            {
                if(count($riscencv)> 0)
                {
                    ...
                    if($boolprint) echo 'sostituito centrocampista';
                }
            }
        }
        ...
        if($sostituzionidafare > $sostituzionifatte && $attdasostituire > 0 )// se devo sostituire attaccanti
        {
            for($index = 1; $index<= $attdasostituire; $index++)//ciclo per i attaccanti da sostituire 
            {
                if(count($risattcv)> 0)
                {
                    ...
                    if($boolprint) echo 'sostituito attaccante';
                }
            }
        }
