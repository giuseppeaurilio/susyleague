...
foreach($arraysquadre as $squadra){
    echo '<tr>';
        ...
        echo '<td>'.$squadra->marcatoritresf.'</td>';
        echo '<td>'.$squadra->vittorietresf.'</td>';
        echo '<td>'.$squadra->pareggitresf.'</td>';
        echo '<td>'.$squadra->sconfittetresf.'</td>';
        echo '<td>'.$squadra->golfattitresf.'</td>';
        echo '<td>'.$squadra->golsubititresf.'</td>';
    echo '</tr>';
}
?>
</table>
