    ...
    switch($action)
    {
		case("inviaformazione"):
			...
			try{
				...
				$queryformazioneinviata="UPDATE `calendario` SET `formazione_casa_inviata`=1 WHERE id_giornata = $id_giornata and id_sq_casa =$id_squadra ";
				$queryformazioneinviata="UPDATE `calendario` SET `formazione_ospite_inviata`=1 WHERE id_giornata = $id_giornata and id_sq_ospite =$id_squadra ";
