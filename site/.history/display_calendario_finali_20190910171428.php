...
foreach ($giornate as $partita) {
	echo '<div class="finale">'; 
		...
		echo '<textarea readonly rows="10" style="'.( $partita->commentoAndata == "" ?  "display:none;" : "").'" >Il punto del presidente:'
		...
		echo '</div>';
		echo '<div class="commento">';
		echo '<textarea readonly rows="10" style="'.( $partita->commentoRitorno == "" ?  "display:none;" : "").'" >Il punto del presidente:'
