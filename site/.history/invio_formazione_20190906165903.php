...
if ($num_giornate>0) {
	...
	while ($row=$result_giornate->fetch_assoc()) {
		...
		{ $descrizioneGiornata ="Coppa Italia - Girone A. Giornata". (($id-33)/3 > 5 ? ($id-33)/3 - 4 : $id/3 +1 );}
		else if ($id>48 && $id<= 63)
		{ $descrizioneGiornata ="Coppa Italia - Girone B. Giornata". (($id-48)/3 > 5 ? ($id-33)/3 - 4 : ($id-33)/3 +1 );}
		else if ($id == 64 )
