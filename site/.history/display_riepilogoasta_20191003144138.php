...
foreach($squadre as $squadra)
{
    ...
    foreach($riepilogo["giocatori"] as $row){
        switch($row["ruolo"])
        {
            ...
            break;
            case "D":
                echo '<tr><td>Difensori</td><td>'.$row["numero"]. '</td><td>'.$row["costo"].'</td></tr>';
            break;
            case "C":
                echo '<tr><td>Centrocampisti</td><td>'.$row["numero"]. '</td><td>'.$row["costo"].'</td></tr>';
            break;
            case "A":
                echo '<tr><td>Attaccanti</td><td>'.$row["numero"]. '</td><td>'.$row["costo"].'</td></tr>';
            break;
        }
    }
    echo '</table>';
