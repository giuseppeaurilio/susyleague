...
if ($num_giornate>0) {
	...
	while ($row=$result_giornate->fetch_assoc()) {
		...
		{ $descrizioneGiornata ="Coppa Italia - Girone Narpini. Giornata ".$id . ' ' .(floor(($id-32) /3));}
		else if ($id>48 && $id<= 63)
		{ $descrizioneGiornata ="Coppa Italia - Girone Gianluca. Giornata ".$id . ' ' . (floor(($id-47) /3));}//(floor(($id-48)/3) + 1);}
		else if ($id == 64 )
