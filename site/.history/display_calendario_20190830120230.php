...
while ($row=$result->fetch_assoc()) {
	...
	-- d.gol_casa, d.gol_ospite, d.voto_casa, d.voto_ospite  
	a.gol_casa, a.gol_ospite, a.punti_casa, a.punti_ospiti
	...
	-- left join punteggio_finale as d on a.id_giornata=d.id_giornata and a.id_partita=d.id_partita 
