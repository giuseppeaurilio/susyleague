...
?>
">
	<?php if ($i==0) {echo 	"<td rowspan='11' style='background-color: rgba(0,204,51,0.2);'><div class='rotate'style='width: auto;'> Titolari</div></td>";  } ?>
	<?php if ($i==11) {echo "<td rowspan='8' style='background-color: rgba(204,51,51,0.2);'><div class='rotate' style='width: auto;'> Riserve </div></td>";  } ?>
			<td><?php echo $row["nome"]; ?></td>
			<td><?php echo $row["squadra_breve"]; ?></td>
			<td><?php echo $row["ruolo"]; ?></td>
			<td class="voto"><?php echo $row["voto"]; ?></td>
