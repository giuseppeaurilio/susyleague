...
$query2="Select *, sum(punti_casa + md_casa + fattorecasa) as tot_casa, sum(punti_ospiti + md_ospite) as tot_ospite, b.squadra as sq_casa, c.squadra as sq_ospite
