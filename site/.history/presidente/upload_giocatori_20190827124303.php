	...
	if (($handle = fopen($filename, "r")) !== FALSE) {
		...
		while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
			...
			try{
				...
				{
					$queryinsertsquadra="INSERT INTO `squadre_serie_a`(`squadra`, `squadra_breve`, 'id') VALUES ('$squadra','$squadra_breve', $row)";
				...
				$queryinsertgiocatore="INSERT INTO `giocatori`(`id`, `ruolo`,`nome`,`id_squadra` ) SELECT $data[0],'$data[1]','$nome',id 
