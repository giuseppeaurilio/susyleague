...
foreach($arraypartite as $partita){
    ...
    $queryinsert = 'INSERT INTO `calendario`( `gol_casa`, `gol_ospiti`, `punti_casa`, `punti_ospiti`) VALUES ('.$result["golCasa"].'
    ...
    print("<pre>".print_r($queryinsert   ,true)."</pre>").'<br>';
    // $result=$conn->query($query);
