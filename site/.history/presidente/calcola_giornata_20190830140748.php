...
$query2="Select *, sum(punti_casa + md_casa + fattorecasa) as tot_casa
...
while ($row=$result_giornata->fetch_assoc()) {
	...
	$addizionalecasa = $row["id_casa"];
	$numero_giocanti_casa = $row["id_casa"];
	$voto_netto_casa = $row["id_casa"];
	$media_difesa_avversaria_casa = $row["id_casa"];
	$voto_totale_casa = $row["id_casa"];
	$gol_casa = $row["id_casa"];
	$numero_giocanti_ospite  = $row["id_casa"];
	$voto_netto_ospite = $row["id_casa"];
	$media_difesa_avversaria_ospite = $row["id_casa"];
	$voto_totale_ospite = $row["id_casa"];
	$gol_ospite = $row["id_casa"];
...
<a href="invio_formazione_squadra.php?&id_giornata=<?php  echo $id_giornata; ?>&id_squadra=<?php  echo $id_casa; ?>">Invia Formazione</a>
	...
	and a.id_giocatore=b.id and a.id_squadra_sa=c.id ";
...
<button type="button" id="btn_invia">Calcola Risultati</button>
