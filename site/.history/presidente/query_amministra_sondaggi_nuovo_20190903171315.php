...
$testo=real_escape_string($_POST["testo"]);

// $opzioni=$_POST["mytext"];
// $risp_multipla=$_POST["risp_multipla"];

$g_fine=real_escape_string($_POST['g_fine']);
$m_fine=real_escape_string($_POST['m_fine']);
$a_fine=real_escape_string($_POST['a_fine']);
$h_fine=real_escape_string($_POST['h_fine']);
$min_fine=real_escape_string($_POST['min_fine']);
