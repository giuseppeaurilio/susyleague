...
foreach($giornate as $giornata){
    ...
    switch($index){
        ...
        echo 'Andata:<input type="text" name="dataAndata" size="5" value="'. $giornata['inizion_a'] .'" id="txtDataAndata'.$giornata["id_giornata"].'">';
        ...
        case 73:
        case 73:
        echo 'Ritorno:<input type="text" name="dataAndata" size="5" value="'. $giornata['fine_a'] .'" id="txtDataAndata'.$giornata["id_giornata"].'">';
