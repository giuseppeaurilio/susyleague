...
foreach($giornate as $giornata){
    ...
    switch($index){
        ...
        echo '</select>';
        echo '<input type="button" class="btn_salvasquadre" id="salvasquadre'.$giornata["id_giornata"].'" value="Salva Squadre"/>';
        echo '<br>';
        ...
        $date_string = "";
        echo 'Andata:<input type="text" name="dataAndata" class="datetime_class" size="12" value="'. $date_string .'" id="txtDat   aAndata'.$giornata["id_giornata"].'">';
