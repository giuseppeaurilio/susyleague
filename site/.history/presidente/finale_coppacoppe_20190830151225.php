...
$(document).ready(function(){
    ...
    SalvaSquadrePartita = function(){
        ...
        if(id1 == null || id1 == "")
        {
            alert('selezionare la squadra di Peppe');
            return false;
        }
        if(id2 == null || id2 == "")
        {
            alert('selezionare la squadra avversaria');
            return false;
        }
...
echo '</form>';
echo '<br>';
echo '<a href="calcola_giornata.php?&id_giornata='.$id_giornata .'">Calcola Giornata</a>';
