...
Testo:<input type="text" name="testo" size="120" value="'. $testo .'" ><br>
Fine:
Giorno:<input type="text" name="g_fine" size="5" value="'. $fine_a['day'] .'" >
Mese:<input type="text" name="m_fine" size="5" value="'. $fine_a['month'] .'" >
Anno:<input type="text" name="a_fine" size="5" value="'. $fine_a['year'] .'">
Ore:<input type="text" name="h_fine" size="5" value="'. $fine_a['hour'] .'">
Minuti:<input type="text" name="min_fine" size="5" value="'.$fine_a['minute'] .'"><br>
