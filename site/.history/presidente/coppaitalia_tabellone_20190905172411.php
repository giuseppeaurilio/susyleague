...
foreach($giornate as $giornata){
    ...
    switch($index){
        ...
        $date_string = "";
        echo 'Andata:<input type="text" name="dataAndata" class="datetime_class" size="5" value="'. $date_string .'" id="txtDat   aAndata'.$giornata["id_giornata"].'">';
        ...
        $date_string = "";
        echo 'Ritorno:<input type="text" name="dataAndata" class="datetime_class" size="5" value="'. $date_string .'" id="txtDataAndata'.$giornata["id_giornata"].'">';
