...
$(document).ready(function(){
    ...
    $("#btnCambioPassword").off("click").bind("click", callCambioPassword);
})

callCambioPassword = function()
{
    var uname = '<?php if (!(isset($_SESSION['allenatore']) && $_SESSION['allenatore'] != '')) { 
...
<div class="button" ><a href="#" id="btnCambioPassword" class="button">Salva</a></div>