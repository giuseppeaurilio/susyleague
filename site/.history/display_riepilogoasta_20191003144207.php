...
foreach($squadre as $squadra)
{
    ...
    foreach($riepilogo["giocatori"] as $row){
        ...
        {
            case "P":
                echo '<tr><td>Portieri</td><td>'.$row["numero"]. '</td><td>'.$row["costo"].'</td><td>'.getNumPortieri()-$row["numero"].'</td></tr>';
            break;
            case "D":
                echo '<tr><td>Difensori</td><td>'.$row["numero"]. '</td><td>'.$row["costo"].'</td><td>'.getNumDifensori()-$row["numero"].'</td></tr>';
            break;
            case "C":
                echo '<tr><td>Centrocampisti</td><td>'.$row["numero"]. '</td><td>'.$row["costo"].'</td><td>'.getNumCentrocapisti()-$row["numero"].'</td></tr>';
            break;
            case "A":
                echo '<tr><td>Attaccanti</td><td>'.$row["numero"]. '</td><td>'.$row["costo"].'</td><td>'.getNumAttaccanti()-$row["numero"].'</td></tr>';
            break;
        }
    }
    echo '</table>';
