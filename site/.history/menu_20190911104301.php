...
<a href="/homepage/home.php" style="color:white;">
	<div style="width: 100%; overflow: hidden; vertical-align: middle;">
			<div style="width: 60%; float: left;"> <h1 style="margin: 10px 0 0 0;">Serie A Centro Tim di NG</h1><h2 style="background-color:transparent ; padding: 0;"> SusyLeague <?php  echo $anno; ?></h2> </div>
