...
">
	...
	?>
	<?php if ($i==0) {echo 	"<td rowspan='11' background-color: white;><div class='rotate'> Titolari</div></td>";  } ?>
	<?php if ($i==11) {echo "<td rowspan='8' background-color: white;><div class='rotate'> Riserve </div></td>";  } ?>
...
<?php
		...
		$filename = str_replace("% %", "-", "https://d22uzg7kr35tkk.cloudfront.net/web/campioncini/small/".$nome_giocatore_pulito.".png"); 
?>
	<?php if ($i==0) {echo 	"<td rowspan='11'><div class='rotate'> Titolari</div></td>";  } ?>
	<?php if ($i==11) {echo "<td rowspan='8'><div class='rotate'> Riserve </div></td>";  } ?>
		<td><?php echo '<img style="height: 20;width: 15px;	" src='.$filename.'>';?></td>
		<td ><div class="truncate"><?php echo $row["nome"]; ?></div></td>
		<td><?php echo $row["squadra_breve"]; ?></td>
		<td><?php echo $row["ruolo"]; ?></td>
