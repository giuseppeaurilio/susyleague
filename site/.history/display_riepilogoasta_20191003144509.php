...
foreach($squadre as $squadra)
{
    ...
    foreach($riepilogo["giocatori"] as $row){
        ...
        {
            case "P":
                echo '<tr><td>Portieri</td><td>'.$row["costo"].'</td><td>'.$row["numero"]. '</td><td>'.getNumPortieri().'</td></tr>';
            break;
            case "D":
                echo '<tr><td>Difensori</td><td>'.$row["costo"].'</td><td>'.$row["numero"]. '</td><td>'.getNumDifensori().'</td></tr>';
            break;
            case "C":
                echo '<tr><td>Centrocampisti</td><td>'.$row["costo"].'</td><td>'.$row["numero"]. '</td><td>'.getNumCentrocampisti().'</td></tr>';
            break;
            case "A":
                echo '<tr><td>Attaccanti</td><td>'.$row["costo"].'</td><td>'.$row["numero"]. '</td><td>'.getNumAttaccanti().'</td></tr>';
            break;
        }
    }
    echo '</table>';
